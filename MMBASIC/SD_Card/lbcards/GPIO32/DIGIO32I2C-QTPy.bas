...
' Setup the I2C2 port for the MCP23017
...
setupMCP:
I2C2 WRITE MCP23017_I2CADR0, 0, 2, MCP23017_IODIRA, &H00
If MM.I2C2 = 0 GoTo skipFail1
Print "Problem accessing MCP23017 at 0x20"
End
skipFail1:
I2C2 WRITE MCP23017_I2CADR0, 0, 2, MCP23017_IODIRB, &H00
If MM.I2C2 = 0 Then GoTo skipFail2
Print "Problem accessing MCP23017 at 0x21"
End
skipFail2:
I2C2 WRITE MCP23017_I2CADR1, 0, 2, MCP23017_IODIRA, &H00
I2C2 WRITE MCP23017_I2CADR1, 0, 2, MCP23017_IODIRB, &H00
...
loopVal = &H01
loop1:
I2C2 WRITE MCP23017_I2CADR0, 0, 2, MCP23017_OLATA, loopVal
Pause delayTime
If Inkey$ <> "" GoTo Done
loopVal = loopVal * 2
If loopVal < 256 GoTo loop1
I2C2 WRITE MCP23017_I2CADR0, 0, 2, MCP23017_OLATA, 0

loopVal = &H01
loop2:
I2C2 WRITE MCP23017_I2CADR0, 0, 2, MCP23017_OLATB, loopVal
Pause delayTime
If Inkey$ <> "" GoTo Done
loopVal = loopVal * 2
If loopVal < 256 GoTo loop2
I2C2 WRITE MCP23017_I2CADR0, 0, 2, MCP23017_OLATB, 0

loopVal = &H01
loop3:
I2C2 WRITE MCP23017_I2CADR1, 0, 2, MCP23017_OLATA, loopVal
Pause delayTime
If Inkey$ <> "" GoTo Done
loopVal = loopVal * 2
If loopVal < 256 GoTo loop3
I2C2 WRITE MCP23017_I2CADR1, 0, 2, MCP23017_OLATA, 0

loopVal = &H01
loop4:
I2C2 WRITE MCP23017_I2CADR1, 0, 2, MCP23017_OLATB, loopVal
Pause delayTime
If Inkey$ <> "" GoTo Done
loopVal = loopVal * 2
If loopVal < 256 GoTo loop4
I2C2 WRITE MCP23017_I2CADR1, 0, 2, MCP23017_OLATB, 0
GoTo loopBack
